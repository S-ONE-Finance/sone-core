...
export interface SoneSwapRouterContract
  extends Truffle.Contract<SoneSwapRouterInstance> {
  "new"(
    factory_: string,
    WETH_: string,
    meta?: Truffle.TransactionDetails
  ): Promise<SoneSwapRouterInstance>;
}

type AllEvents = never;

export interface SoneSwapRouterInstance extends Truffle.ContractInstance {
