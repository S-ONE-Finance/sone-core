...
export interface ISoneSwapRouterContract
  extends Truffle.Contract<ISoneSwapRouterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ISoneSwapRouterInstance>;
}

type AllEvents = never;

export interface ISoneSwapRouterInstance extends Truffle.ContractInstance {
  ...
  addLiquidityOneTokenETHExactETH: {
    (
      amountTokenMin: number | BN | string,
      amountETHMin: number | BN | string,
      amountOutTokenMin: number | BN | string,
      path: string[],
      to: string,
      deadline: number | BN | string,
      txDetails?: Truffle.TransactionDetails
  ...
  addLiquidityOneTokenETHExactToken: {
    (
      amountIn: number | BN | string,
      amountTokenMin: number | BN | string,
      amountETHMin: number | BN | string,
      amountOutETHMin: number | BN | string,
      path: string[],
      to: string,
      deadline: number | BN | string,
      txDetails?: Truffle.TransactionDetails
